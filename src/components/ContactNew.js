...
const ContactNew = ({ onAddContact }) => {
  ...
  const [isContactAdded, setIsContactAdded] = useState(false); // Track if the contact has been added
  ...
  const handleSubmit = (e) => {
    ...
    if (!input.checkValidity()) {
      ...
      setIsContactAdded(false); // Reset the flag
